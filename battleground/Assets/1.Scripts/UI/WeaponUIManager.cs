...
/// <summary>
/// 무기를 획득하면 획드한 무기를 UI를 통해 보여줌
/// 현재 잔탄량과 전체 소지할수 있는 총알량을 출력
/// </summary>
public class WeaponUIManager : MonoBehaviour
{
    public Color bulletColor = Color.white;
    public Color emptyBulleColor = Color.black;
    public Color noBulletColor; //투명하게 색깔표시
    ...
    public void UpdateWeaponHUD(Sprite weaponSprite, int bulletLeft, int fullMag, int extraBullets)
    {
        ...
        foreach(Transform bullet in bulletMag.transform)
        {
            ...
            {
                //사용한 탄.
                bullet.GetComponent<Image>().color = emptyBulleColor;
            }
            bulletCount++;
        }
